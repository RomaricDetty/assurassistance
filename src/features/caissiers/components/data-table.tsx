...
// import { searchParams } from "@/features/users/ordinary/utils/ordinary-search-params";
...
export function DataTable<TData, TValue>({columns, data, defaultColumnFilters = [], filterFields = [],}: DataTableProps<TData, TValue>) {
    ...
    React.useEffect(() => {
        // Skip effect if filterFields is empty
        ...
        /*  const hasChanged = JSON.stringify(newSearch) !== JSON.stringify(search);
        if (hasChanged) {
          setSearch(newSearch);
        } */
        ...
        >
            <div className="flex h-full w-full flex-col gap-3 sm:flex-row">
                <div className="flex max-w-full flex-1 flex-col gap-4 overflow-hidden p-1">
                    {/* <DataTableFilterInput value="amount" label="Amount" type="input" /> */}
